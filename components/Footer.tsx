            ...
            <footer className="w-full py-20 ">
                <div className="mx-auto max-w-7xl px-4  sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center justify-center lg:justify-between flex-col lg:flex-row pb-12 sm:-pt-2 sm:pb-2 gap-7 lg:gap-0 border-b border-gray-200">
                        <h1 className="flex lg:p-2 justify-center items-center text-2xl font-bold p-7">Hamid-Homes</h1>
                        ...
                        >
                            Contact us<svg width="17" height="12" viewBox="0 0 17 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div className="py-9 border-t border-gray-200">
                        <div className="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
                            <span className="text-sm">
                                ©<a href="https://pagedone.io/">Hamid-Homes</a> 2025, All rights reserved.
                            </span>
                            <span className="items-center ">Updated January 2025: By searching, you agree to the <a className="hover:underline" href="">Terms of Use</a> and <a className="hover:underline" href=""> Privacy Policy.</a></span>
